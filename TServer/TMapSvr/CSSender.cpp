								 ...
								 DWORD dwTick)
{
	...
	BYTE bColor = !pPlayer->CanFight(m_bType, m_bCountry, m_bCountry) ? TNCOLOR_ALLI : TNCOLOR_ENEMY;
...
void CTPlayer::SendCS_ADDSELFOBJ_ACK(CTSelfObj * pSelf, BYTE bNewMember, DWORD dwTick)
{
	...
	pMSG->SetID(CS_ADDSELFOBJ_ACK)
		...
		<< pSelf->m_bCountry
	//	<< pSelf->m_bAidCountry
		<< pSelf->GetColor( m_dwID, GetPartyID(), m_bCountry)
		<< pSelf->m_bLevel
		<< pSelf->GetMaxHP()
		<< pSelf->m_dwHP
		<< pSelf->GetMaxMP()
                                       ...
                                       DWORD dwTick)
{
	...
	pMSG->SetID(CS_ADDRECALLMON_ACK)
		...
		<< pMON->m_bCountry
	//	<< pMON->m_bAidCountry
		<< pMON->GetColor( m_dwID, GetPartyID(), m_bCountry)
		<< pMON->m_bLevel
		<< pMON->GetMaxHP()
		<< pMON->m_dwHP
		<< pMON->GetMaxMP()
