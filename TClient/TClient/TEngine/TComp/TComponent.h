...
public:	
	...
	// Arab Ver.
	BOOL CheckRightChar(CString strText, int nIndex, int &nNextCount);
	BOOL CheckLeftChar(CString strText, int nIndex, int &nPrevCount);
	CString GetCaretPoint(LPCTSTR lpstrText, int nCaret);
	// Arab Ver.
	void TextToPoint( LPCTSTR strText, int nPos, CPoint& pt, BOOL bFLIP_SCREEN = FALSE, int nLine = 0xFF );	
